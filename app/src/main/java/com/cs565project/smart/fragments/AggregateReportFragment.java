...
////            data.setValueFormatter((value, entry, dataSetIndex, viewPortHandler) -> myEmotionUtil.getEmoji(value));
...
//        }
    ...
    private Runnable postLoadData = new Runnable() {
        ...
        public void run() {
            ...
            myChart.animateY(600, Easing.EaseInOutQuad);
